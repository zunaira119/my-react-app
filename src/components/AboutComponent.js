    ...
    <div className="about-box-main">
        <div className="container">
            <div className="row">
                ...
                <div className="col-lg-6">
                    <div className="banner-frame"> <img class="img-thumbnail img-fluid" src="images/about-img.jpg" alt="" />
                    </div>
                </div>
            </div>
                    ...
                    <div className="hover-team">
                        <div className="our-team"> <img src="images/img-1.jpg" alt="" />
                            <div className="team-content">
                                <h3 className="title">Williamson</h3> <span class="post">Web Developer</span> </div>
                            <ul className="social">
                                <li>
