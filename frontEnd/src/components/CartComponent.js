                ...
                <div className="cart-box-main">
                    <div className="container">
                                ...
                                <div className="table-main table-responsive">
                                    <table className="table">
                                        ...
                                        <tr>
                                            ...
                                            <td className="quantity-box"><input type="number" size="4" value="1" min="0"
                                        ...
                                        <tr>
                                            ...
                                            <td className="quantity-box"><input type="number" size="4" value="1" min="0"
                                                                            step="1" className="c-input-text qty text"/>
                                            </td>
                                            <td className="total-pr">
                                                <p>$ 80.0</p>
                                            </td>
                            ...
                            <div className="col-lg-6 col-sm-6">
                                <div className="coupon-box">
                                    <div className="input-group input-group-sm">
                                        <input className="form-control" placeholder="Enter your coupon code"
                        ...
                        <div className="row my-5">
                            ...
                            <div className="col-12 d-flex shopping-box"><Link to="/checkout"
                                                                          className="ml-auto btn hvr-hover">Checkout</Link>
                            </div>
                        </div>
